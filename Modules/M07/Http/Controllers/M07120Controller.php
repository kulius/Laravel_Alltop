...
class M07120Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //處理進度
        $aProcessStatus = $this->Repo->ProcessStatus_Combo(1);
        //處理進度
        ...
        $data = tSysDemandRepo::AlltopSetting(
        ...
        return view('m07::m07120.index', array(
            'data'            => $data,
            'aFillUnit'       => $aFillUnit,
    ...
    public function view(Request $request, $status = null, $id = null)
    {
        ...
        return view('m07::m07120.view', array(
    ...
    public function save(Request $request, $status = null, $id = null)
    {
        ...
        //Array不能放進去 不然會產生string to array的錯誤
        ...
        if ($event === 'save') {
            ...
            return redirect()->route('m07120_view', array('edit', $result->ID));
