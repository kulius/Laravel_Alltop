...
<form id='main' method='POST' autocomplete='off'>
    ...
    $aBody[] = array("flex" => 'auto', "body" => $eZui->setBtnSubmit(array('ex' => 'save', 'value' => 'save','text'=>'複製場地管理層級設定')));
    $sHtml .= $eZui->setGroup(array('body' => $aBody));
    ...
    $aField[] = array("head" => _("審核單位"), "name" => "Result", "width" => "10%", "align" => "left");
    $aField[] = array("head" => _("開放排課"), "name" => "Result", "width" => "10%", "align" => "left");
    $aField[] = array("head" => _("星期節次"), "name" => "Result", "width" => "10%", "align" => "left");
