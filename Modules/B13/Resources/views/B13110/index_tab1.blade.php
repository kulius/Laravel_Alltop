...
<form id='main' method='POST' autocomplete='off'>
    ...
    $aField[] = array("head" => _("租金/管理費"), "name" => "Result", "width" => "10%", "align" => "left");
    $aField[] = array("head" => _("空調費用"), "name" => "Result", "width" => "10%", "align" => "left");
    $aField[] = array("head" => _("租金單位"), "name" => "Result", "width" => "10%", "align" => "left");
    $aField[] = array("head" => _("布置費用"), "name" => "Result", "width" => "10%", "align" => "left");
    $aField[] = array("head" => _("撤場費用"), "name" => "Result", "width" => "10%", "align" => "left");
    $aField[] = array("head" => _("保證金"), "name" => "Result", "width" => "10%", "align" => "left");
    ...
    foreach ($data as $skData => $svData) {
        ...
        $aBtn   = array();
        $aBtn[] = $eZui->setBtnHref(array("ex" => "view", "small" => true, "route" => "b13110_tab1_view", "param" => array("view")));
        $aBtn[] = $eZui->setBtnHref(array("ex" => "edit", "small" => true, "route" => "b13110_tab1_view", "param" => array("edit")));
    ...
    $aParams = array(
    'aTabInfo' => array(
    'b13110' => array('param' => "", 'title'=>'保管組'),
    'b13110_tab1' => array('param' => "", 'title'=>'事務組', 'view' => $sHtml, 'current' => 'active'),
