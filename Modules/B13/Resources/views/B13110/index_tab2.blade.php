...
<form id='main' method='POST' autocomplete='off'>
    ...
    $aField[] = array("head" => _("容納人數"), "name" => "Result", "width" => "10%", "align" => "left");
    $aField[] = array("head" => _("開放外借"), "name" => "Result", "width" => "10%", "align" => "left");
    $aField[] = array("head" => _("開放排課"), "name" => "Result", "width" => "10%", "align" => "left");
    ...
    foreach ($data as $skData => $svData) {
        ...
        $aBtn   = array();
        $aBtn[] = $eZui->setBtnHref(array("ex" => "view", "small" => true, "route" => "b13110_tab2_view", "param" => array("view")));
        $aBtn[] = $eZui->setBtnHref(array("ex" => "edit", "small" => true, "route" => "b13110_tab2_view", "param" => array("edit")));
    ...
    'b13110_tab2' => array('param' => "", 'title'=>'場地管理單位', 'view' => $sHtml, 'current' => 'active'),
    )
    );
