...
<form id='main' method='POST' autocomplete='off'>
    ...
    $aBody = array();
    $aBody[] = array("flex" => '2', "body" => $eZui->setTextBox(array("head" => __("場地編號"), "name" => "Building", "value" => '', "option" => $aOption,'req'=>true, "def" => _("請選擇"))));
    $aBody[] = array("flex" => '2', "body" => $eZui->setComboBox(array("head" => __("所屬大樓"), "name" => "Semester_srh", "value" => old("Semester_srh"),'req'=>true, "option" => $aOption,"def" => _("請選擇"))));
    $aBody[] = array("flex" => '2', "body" => $eZui->setComboBox(array("head" => __("所在樓層"), "name" => "DayfgID_srh", "value" => old("DayfgID_srh"), "option" => $aOption,"def" => _("請選擇"))));
    $aBody[] = array("flex" => '2', "body" => $eZui->setComboBox(array("head" => __("場地類型"), "name" => "ClassTypeID_srh", "value" => old("ClassTypeID_srh"),"option" => $aOption,  "def" => _("請選擇"))));
    $aBody[] = array("flex" => '2', "body" => $eZui->setComboBox(array("head" => __("場地名稱"), "name" => "College_srh", "value" => old("College_srh"),'req'=>true, "option" => $aOption, "def" => _("請選擇"))));
    ...
    $aBody[] = array("head" => _("空調費用"), "flex" => "2", "body" => $eZui->setTextBox(array('status'=>'view')));
    $aBody[] = array("head" => _("租金單位"), "flex" => "2", "body" => $eZui->setTextBox(array('status'=>'view')));
    $aBody[] = array("head" => _("佈置費用"), "flex" => "2", "body" => $eZui->setTextBox(array('status'=>'view')));
    $aBody[] = array("head" => _("撤場費用"), "flex" => "2", "body" => $eZui->setTextBox(array('status'=>'view')));
    $aBody[] = array("head" => _("保證金"), "flex" => "2", "body" => $eZui->setTextBox(array('status'=>'view')));
