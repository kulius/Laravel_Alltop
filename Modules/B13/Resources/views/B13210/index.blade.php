...
<form id='main' method='POST' autocomplete='off'>
    ...
    $aBody[] = array("head" => _("申請人身分"), "flex" => "4", "body" => $eZui->setFont(array("text" => _("Font"))));
    $sHtml .= $eZui->setGroup(array('body' => $aBody));
    $aBody   = array();
    $aBody[] = array('flex' => '4', 'body' => $eZui->setTextBox(array('head' => __('申請人姓名'), 'name' => 'text', 'value' => old('text') )));
    $aBody[] = array("head" => _("學生學號"), "flex" => "4", "body" => $eZui->setFont(array("text" => _("Font"))));

    $aBody[] = array('flex' => '4', 'body' => $eZui->setTextBox(array('head' => __('申請人系所/單位'), 'name' => 'text', 'value' => old('text') )));
    $aBody[] = array('flex' => '4', 'body' => $eZui->setTextBox(array('head' => __('申請人EMAIL'), 'name' => 'text', 'value' => old('text') )));
    $aBody[] = array('flex' => '4', 'body' => $eZui->setTextBox(array('head' => __('申請人電話'), 'name' => 'text', 'value' => old('text') )));
    $sHtml .= $eZui->setGroup(array('body' => $aBody));
...
//第一個CARD填寫場地與時段1
    ...
    $aBody[] = array('flex' => '3', 'body' => $eZui->setDateTimeBox(array('head' => _('租借日期'), 'name' => 'drop', 'value' => '', 'option' => '', 'req' => false, 'def' => '請選擇')));

    // "flex" => 4 相對創意布局元件寬度，非螢幕寬
    $aBody1   = array();
    $aBody1[] = array("flex" => 5, "body" =>$eZui->setComboBox(array("name" => "Combo", "value" => '空值', "option" => $aOption, "req" => true, "def" => _("請選擇"))),);
    $aBody1[] = array("flex" => "2", "body" => $eZui->setFont(array("text" => _("~"))));
    $aBody1[] = array('flex' => 5, 'body' =>$eZui->setTextBox(array('name' => 'text', 'value' => old('text') )));
    $sGroup = $eZui->setGroup(array("body" => $aBody1));
    // "flex" => 12 相對螢幕寬度
    $aBody[] = array('flex' => '3', "head" => _("租借節次"), "body" => $sGroup);
...
//第二個CARD填寫場地與時段2
    ...
    // "flex" => 4 相對創意布局元件寬度，非螢幕寬
    $aBody1   = array();
    $aBody1[] = array("flex" => 5, "body" =>$eZui->setComboBox(array("name" => "Combo", "value" => '', "option" => $aOption, "req" => true, "def" => _("請選擇"))),);
    $aBody1[] = array("flex" => "2", "body" => $eZui->setFont(array("text" => _("~"))));
    $aBody1[] = array('flex' => 5, 'body' =>$eZui->setTextBox(array('name' => 'text', 'value' => old('text') )));
    $sGroup = $eZui->setGroup(array("body" => $aBody1));
