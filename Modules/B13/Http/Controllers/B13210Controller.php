...
class B13210Controller extends Controller
{
...
//班級
        ...
        return view('b13::B13210.index', array(
            'data'       => $data,
            'aYear'      => $aYear,
            'aSemester'  => $aSemester,
            'aDayfg'     => $aDayfg,
...
//班級
        ...
        return view('b13::B13210.index_tab1', array(
            'data'       => $data,
            'aYear'      => $aYear,
            'aSemester'  => $aSemester,
            'aDayfg'     => $aDayfg,
...
//班級
        ...
        return view('b13::B13210.index_tab2', array(
            'data'       => $data,
            'aYear'      => $aYear,
            'aSemester'  => $aSemester,
            'aDayfg'     => $aDayfg,
    ...
    public function view(Request $request, $status = null, $id = null)
    {
        ...
        return view('b13::B13210.view', array(
            'data'      => $data,
            'status'    => $status,
            'id'        => $id,
            'aYear'     => $aYear,
 ...
 */
    public function tab1_view(Request $request, $status = null, $id = null)
    {
        ...
        return view('b13::B13210.tab1_view', array(
            'data'      => $data,
            'status'    => $status,
            'id'        => $id,
            'aYear'     => $aYear,
    ...
    public function tab2_view(Request $request, $status = null, $id = null)
    {
        ...
        return view('b13::B13210.tab2_view', array(
            'data'      => $data,
            'status'    => $status,
            'id'        => $id,
            'aYear'     => $aYear,
    ...
    public function save(Request $request, $status = null, $id = null)
    {
        ...
        if ($event === 'save') {
            ...
            return redirect()->route('B13210_view', array($model));
        } else {
            return view('b13::B13210.view', array(
                'data'   => $data,
                'status' => $status,
