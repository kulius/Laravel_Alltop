...
class B13240Controller extends Controller
{
...
//班級
        ...
        return view('b13::B13240.index', array(
            'data'       => $data,
            'aYear'      => $aYear,
            'aSemester'  => $aSemester,
            'aDayfg'     => $aDayfg,
...
//班級
        ...
        return view('b13::B13240.index_tab1', array(
            'data'       => $data,
            'aYear'      => $aYear,
            'aSemester'  => $aSemester,
            'aDayfg'     => $aDayfg,
...
//班級
        ...
        return view('b13::B13240.index_tab2', array(
            'data'       => $data,
            'aYear'      => $aYear,
            'aSemester'  => $aSemester,
            'aDayfg'     => $aDayfg,
...
//班級
        ...
        return view('b13::B13240.index_tab3', array(
            'data'       => $data,
            'aYear'      => $aYear,
            'aSemester'  => $aSemester,
            'aDayfg'     => $aDayfg,
...
//班級
        ...
        return view('b13::B13240.index_tab4', array(
            'data'       => $data,
            'aYear'      => $aYear,
            'aSemester'  => $aSemester,
            'aDayfg'     => $aDayfg,
    ...
    public function view(Request $request, $status = null, $id = null)
    {
        ...
        return view('b13::B13240.view', array(
            'data'      => $data,
            'status'    => $status,
            'id'        => $id,
            'aYear'     => $aYear,
 ...
 */
    public function tab1_view(Request $request, $status = null, $id = null)
    {
        ...
        return view('b13::B13240.tab1_view', array(
            'data'      => $data,
            'status'    => $status,
            'id'        => $id,
            'aYear'     => $aYear,
    ...
    public function tab2_view(Request $request, $status = null, $id = null)
    {
        ...
        return view('b13::B13240.tab2_view', array(
            'data'      => $data,
            'status'    => $status,
            'id'        => $id,
            'aYear'     => $aYear,
    ...
    public function tab3_view(Request $request, $status = null, $id = null)
    {
        ...
        return view('b13::B13240.tab3_view', array(
            'data'      => $data,
            'status'    => $status,
            'id'        => $id,
            'aYear'     => $aYear,
    ...
    public function save(Request $request, $status = null, $id = null)
    {
        ...
        if ($event === 'save') {
            ...
            return redirect()->route('B13240_view', array($model));
        } else {
            return view('b13::B13240.view', array(
                'data'   => $data,
                'status' => $status,
