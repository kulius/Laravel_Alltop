...
@section('content')
    ...
    $aField[] = array("head" => _("題目名稱"), "name" => "FieldName2", "width" => "60%", "align" => "center");
    $aField[] = array("head" => _("得分"), "name" => "FieldName3", "width" => "20%", "align" => "center");
    ...
    $aParams =  array(
                'aTabInfo' => array(
                    'c03240_tab2_view_tab1' => array('title'=>'學習策略個人', 'view' => $sTabHtml, 'current' => 'active'),
                    'c03240_tab2_view_tab2' => array('title'=>'學生填寫問卷狀況'),
                )
            );
