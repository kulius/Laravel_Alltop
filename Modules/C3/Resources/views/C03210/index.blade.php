...
@section('content')
    ...
    $aBody[] = array('flex' => 'auto', 'body' => $eZui->setBtnHref(array('ex' => 'add', 'route' => 'c03210_add', 'param' => array('add'))));
    $aBody[] = array("flex" => "auto", "body" => $eZui->setJump(array("ex" => "excel", "text" => "匯入學生分數", "name" => "import", "url" => "c03210_import", "param" => array("head" => "匯入學生分數"))));
    $sHtml .= $eZui->setGroup(array('body' => $aBody));

    // ----- Grid 要顯示的欄位 -----
    $aField   = array();
    $aField[] = array("head" => _("功能"), "name" => "btn", "align" => "right");
    $aField[] = array("head" => _("學年"), "name" => "FieldName1", "width" => "20%", "align" => "center");
    $aField[] = array("head" => _("學期"), "name" => "FieldName2", "width" => "20%", "align" => "center");
    $aField[] = array("head" => _("問卷名稱"), "name" => "FieldName3", "width" => "20%", "align" => "center");
    $aField[] = array("head" => _("題目數量"), "name" => "FieldName4", "width" => "20%", "align" => "center");
    $aField[] = array("head" => _("備註"), "name" => "FieldName5", "width" => "20%", "align" => "center");
    ...
    foreach ($data as $skData => $svData) {
        ...
        $aBtn   = array();
        $aBtn[] = $eZui->setBtnHref(array("ex" => "view", "small" => true, "route" => "c03210_view", "param" => array("view", trim($svData["FieldID"]))));
        $aBtn[] = $eZui->setBtnHref(array("ex" => "edit", "small" => true, "route" => "c03210_edit", "param" => array("edit", trim($svData["FieldID"]))));
    ...
    $aBtn   = array();
    $aBtn[] = $eZui->setBtnHref(array("ex" => "view", "small" => true, "route" => "c03210_view", "param" => array("edit", '')));
    $aBtn[] = $eZui->setBtnHref(array("ex" => "edit", "small" => true, "route" => "c03210_edit", "param" => array("edit", '')));
