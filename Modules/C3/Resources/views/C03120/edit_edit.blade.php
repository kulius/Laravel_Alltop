...
@section('content')
    ...
    $sGetParam = null;
    $aBody[] = array("flex" => "auto", "body" => $eZui->setBtnHref(array("ex" => "leave", 'route' => 'c03120_edit', 'param' => array($sGetParam))));
   ...
   // ----- Grid 要顯示的欄位 -----
    ...
    foreach ($data as $skData => $svData) {
        ...
        $aBtn   = array();
        $aBtn[] = $eZui->setBtnHref(array("ex" => "edit", "small" => true, "route" => "c03120_edit_edit_edit", "param" => array("edit", trim($svData["FieldID"]))));
    ...
    $aBtn   = array();
    $aBtn[] = $eZui->setBtnHref(array("ex" => "edit", "small" => true, "route" => "c03120_edit_edit_edit", "param" => array("edit", '')));
