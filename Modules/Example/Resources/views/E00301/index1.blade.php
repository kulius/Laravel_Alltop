...
$aBody   = array();
$aBody[] = array("flex" => "2", "body" => $eZui->setComboBox(array("head" => _("部別"), "name" => "Dayfg_srh", "value" => old("Dayfg_srh"), "option" => $aDayfg, "select" => false, "def" => _("請選擇"), "attr" => array("onchange='form.submit()'"))));
$aBody[] = array("flex" => "2", "body" => $eZui->setComboBox(array("head" => _("學制"), "name" => "ClassType_srh", "value" => old("ClassType_srh"), "option" => $aClassType, "select" => false, "def" => _("請選擇"), "attr" => array("onchange='form.submit()'"))));
$aBody[] = array("flex" => "2", "body" => $eZui->setComboBox(array("head" => _("學院"), "name" => "College_srh", "value" => old("College_srh"), "option" => $aCollege, "select" => false, "def" => _("請選擇"), "attr" => array("onchange='form.submit()'"))));
$aBody[] = array("flex" => "2", "body" => $eZui->setComboBox(array("head" => _("系所"), "name" => "Unit_srh", "value" => old("Unit_srh"), "option" => $aUnit, "select" => false, "def" => _("請選擇"), "attr" => array("onchange='form.submit()'"))));
$aBody[] = array("flex" => "2", "body" => $eZui->setComboBox(array("head" => _("學程"), "name" => "UnitClassType_srh", "value" => old("UnitClassType_srh"), "option" => $aUnitClassType, "select" => false, "def" => _("請選擇"), "attr" => array("onchange='form.submit()'"))));
$sHtml .= $eZui->setGroup(array('body' => $aBody));

$aBody   = array();
$aBody[] = array('flex' => 'auto', 'body' => $eZui->setBtnSubmit(array('ex' => 'search')));
$aBody[] = array('flex' => 'auto', 'body' => $eZui->setBtnHref(array('ex' => 'add', 'route' => 'a011a0_view', 'param' => array('add'))));
$sHtml .= $eZui->setGroup(array('body' => $aBody));
