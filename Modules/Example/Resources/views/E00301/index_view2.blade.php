...
$aBody   = array();
$aBody[] = array("body" => $eZui->setComboBox(array("head" => _("學年"), "name" => "ACADYear_srh", "value" => '', "option" => '', "select" => false)));
$aBody[] = array("body" => $eZui->setComboBox(array("head" => _("學期"), "name" => "Semester_srh", "value" => '', "option" => '', "select" => false)));
$aBody[] = array("flex" => "2", "body" => $eZui->setComboBox(array("head" => _("學程"), "name" => "SemUnitClassType_srh", "value" => old("SemUnitClassType_srh"), "option" => '', "select" => false, "def" => _("請選擇"), "attr" => array("onchange='form.submit()'"))));
