...
<form id='main' method='POST' autocomplete='off'>
    ...
    switch ($status) {
        ...
        case 'edit':
            ...
            $aBody[] = array('flex' => 'auto', 'body' => $eZui->setBtnHref(array('ex' => 'leave', 'route' => 'm01110')));
            //判斷哪個頁簽的編輯頁傳來的Save狀態
    ...
    $aBody[] = array("flex" => "3", "body" => $eZui->setTextBox(array("head" => __("異動日期"), "name" => "SignMember", "value" => '','status'=>'')));
