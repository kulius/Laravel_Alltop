...
class M04120Controller extends Controller
{
    private $status;
    ...
    {  
        $request->flash();
        $data = array(
            array("aa" => "1054778", "bb" => "李曉明"),
            array("aa" => "1054778", "bb" => "李曉明"),
        );
        return view('m04::M0412
    0.index', array(
            'data'      => $data,
        ));
    }
