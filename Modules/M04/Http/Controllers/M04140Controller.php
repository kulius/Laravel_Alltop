...
class M04140Controller extends Controller
{
    private $status;
    ...
    {  
        ...
        return view('m04::M04140.index', array(
            'data'      => $data,
        ));
    }
    ...
    public function view1(Request $request, $status = null, $id = null){
        ...
        return view('m04::M04140.view1', array(
            'status' => $status,
        ));
    }
    ...
    public function view2(Request $request, $status = null, $id = null){
        $request->flash();
        $data = array(
            array("aa" => "1054778", "bb" => "李曉明", "cc" => "程式設計", "dd" => "3"),
            array("aa" => "1054778", "bb" => "李曉明", "cc" => "程式設計", "dd" => "3"),
        );
        return view('m04::M04140.view2', array(
            'status' => $status,
            'data'      => $data,
