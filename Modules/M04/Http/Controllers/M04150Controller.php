...
class M04150Controller extends Controller
{
    private $status;
    ...
    {  
        $request->flash();
        $data = array(
            array("aa" => "1054778", "bb" => "李曉明", "cc" => "程式設計", "dd" => "3", "ee" => "3", "ff" => "3", "gg" => "3", "hh" => "3", "ii" => "3", "jj" => "3", "kk" => "3", "ll" => "3", "mm" => "3", "nn" => "3", "oo" => "3"),
            array("aa" => "1054778", "bb" => "李曉明", "cc" => "程式設計", "dd" => "3", "ee" => "3", "ff" => "3", "gg" => "3", "hh" => "3", "ii" => "3", "jj" => "3", "kk" => "3", "ll" => "3", "mm" => "3", "nn" => "3", "oo" => "3"),
        );
        return view('m04::M04150.index_tab1', array(
            'data'      => $data,
        ));
    }
    ...
    public function tab2(Request $request)
    {
        ...
        $request->flash();
        $data = array(
            array("aa" => "108", "bb" => "第一學期", "cc" => "多益", "dd" => "550", "ee" => "通過", "ff" => "審核中", "gg" => "成績證明", "hh" => "3", "ii" => "3", "jj" => "3", "kk" => "3", "ll" => "3", "mm" => "3", "nn" => "3", "oo" => "3"),
            array("aa" => "108", "bb" => "第一學期", "cc" => "多益", "dd" => "650", "ee" => "通過", "ff" => "審核中", "gg" => "證書", "hh" => "3", "ii" => "3", "jj" => "3", "kk" => "3", "ll" => "3", "mm" => "3", "nn" => "3", "oo" => "3"),
        );
        return view('m04::M04150.index_tab2', array(
            'data'      => $data,
        ));
    }
    ...
    {  
        ...
        return view('m04::M04150.index_tab3', array(
            'data'      => $data,
        ));
    }
    ...
    {  
        ...
        return view('m04::M04150.index_tab4', array(
            'data'      => $data,
        ));
    }
    ...
    public function tab1_view(Request $request, $status = null, $id = null){
        ...
        return view('m04::M04150.index_tab1_view', array(
            'status' => $status,
        ));
    }


    public function tab31(Request $request)
    {  
        $request->flash();
        $data = array(
            array("aa" => "1054778", "bb" => "李曉明", "cc" => "程式設計", "dd" => "3", "ee" => "3", "ff" => "3", "gg" => "3", "hh" => "3", "ii" => "3", "jj" => "3", "kk" => "3", "ll" => "3", "mm" => "3", "nn" => "3", "oo" => "3"),
        ...
        return view('m04::M04150.index_tab31', array(
            'data'      => $data,
        ));
    }


    public function tab32(Request $request)
    {  
        $request->flash();
        $data = array(
            array("aa" => "1054778", "bb" => "李曉明", "cc" => "程式設計", "dd" => "3", "ee" => "3", "ff" => "3", "gg" => "3", "hh" => "3", "ii" => "3", "jj" => "3", "kk" => "3", "ll" => "3", "mm" => "3", "nn" => "3", "oo" => "3"),
        ...
        return view('m04::M04150.index_tab32', array(
            'data'      => $data,
        ));
    }


    public function tab4_view(Request $request, $status = null, $id = null){

        return view('m04::M04150.index_tab4_view', array(
            'status' => $status,
        ));
    }
