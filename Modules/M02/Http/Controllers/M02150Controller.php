...
class M02150Controller extends Controller
{
    ...
    public function Stda2(Request $request)
    {
        ...
        return view('m02::M02150.Jump.Stda2', array(
            'aYear'     => $aYear,
            'aSemester' => $aSemester,
            //'aActName'  => $aActName,
    ...
    public function Stda(Request $request)
    {
        ...
        return view('m02::M02150.Jump.Stda', array(
            'aYear'     => $aYear,
            'aSemester' => $aSemester,
            //'aActName'  => $aActName,
    ...
    public function Stda3(Request $request)
    {
        ...
        return view('m02::M02150.Jump.Stda3', array(
            'aYear'     => $aYear,
            'aSemester' => $aSemester,
            //'aActName'  => $aActName,
