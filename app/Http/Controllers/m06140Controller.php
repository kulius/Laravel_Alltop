...
class m06140Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $dataMain   = array();
        $dataMain[] = array('a' => 'AS070', 'b' => '場地租借', 'c' => '呂阿美', 'd' => '2019-07-31', 'e' => '新單');

        return view('m06140.index', array(
            'dataMain' => $dataMain,
        ));
    }
    ...
    public function save(Request $request, $status, $id = null)
    {
        ...
        if ($data['event'] === 'save') {
            ...
            return redirect()->route('m06140', array('edit', $result->seq));
        } else {
            return redirect()->route('m06140', array($status, $id));
        }
    }
}
